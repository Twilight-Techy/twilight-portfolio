...
export default function GitHubClientPage({
  ...
  return (
    <div className="flex flex-col min-h-screen bg-background text-foreground dark:bg-zinc-900 dark:text-zinc-100">
      {!live && (
        <div className="bg-amber-500/10 border-b border-amber-500/30 text-amber-900 dark:text-amber-200 text-sm">
          <div className="container mx-auto px-4 py-3">
            Live GitHub data could not be loaded right now.{" "}
            <a
                ...
                {isLoading ? (
                  ...
                  <>
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <span className="font-semibold">{stats.totalWatchers}</span>
                    </div>
                  </>
                )}
              </CardContent>
                  ...
                  <div className="h-48 w-full bg-muted/50 rounded-lg flex items-center justify-center">
                    <div className="text-center space-y-2">
                      ...
                      <p className="text-muted-foreground">
                        {stats.totalRepos} public repositories, most recently pushed first
                      </p>
                      <Badge
                        variant="outline"
                        className="mx-auto bg-primary/10 text-primary dark:bg-blue-500/10 dark:text-blue-400"
                      >
                        {stats.totalStars} stars across all repositories
                      </Badge>
                    </div>
                  </div>
                )}
